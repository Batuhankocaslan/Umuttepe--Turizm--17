<header id="header" id="home">
		    <div class="container">
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="<?php echo base_url() ?>"><h3> <i class="fas fa-ticket-alt"></i> <b>Umuttepe Turizm</b></h3></a>
			      </div>
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          <li class="menu"><a href="<?php echo base_url() ?>">Ana Sayfa</a></li>
			          <li><a href="<?php echo base_url() ?>tiket">Rezervasyon Yap</a></li>
			          <li class="menu"><a href="<?php echo base_url() ?>tiket/cektiket">Bilet Kontrolü</a></li>
