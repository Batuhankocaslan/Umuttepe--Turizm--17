...
<html lang="zxx" class="no-js">
	<head>
		...
		<!-- Site Title -->
		<title>OTOBÜS BİLETİ REZERVASYONU</title>
				...
				<div class="row">
					<div class="col-lg-4">
						...
						<div class="card mb-5">
							...
							<div class="card-body">
								<ul>
									<li>► Varış Noktası <b><?php echo $asal['kota_tujuan']." - ".$jadwal['kota_tujuan']." [".$jadwal['kd_jadwal']."]"; ?></b></li>
									<li>► Otobüs Adı  <b><?php echo $jadwal['nama_bus'];  ?></b></li>
									<li>► Otobüs Numarası  <b><?php echo $jadwal['plat_bus'];  ?></b></li>
									<li>► Kalkış <b><?php echo strtoupper($asal['kota_tujuan'])." - ".$asal['terminal_tujuan']; ?></b></li>
									<li>► Varış <b><?php echo strtoupper($jadwal['kota_tujuan'])." - ".$jadwal['terminal_tujuan']; ?></b></li>
									<li>► Fiyat <b>$<?php echo number_format((float)($jadwal['harga_jadwal']),0,",",".") ; ?></b></li>
									<li>► Kalkış Tarihi <b><?php echo nama_hari($tanggal).",".tgl_indo($tanggal) ?></b></li>
									<li>► Kalkış Zamanı <b>at <?php echo $jadwal['jam_berangkat_jadwal']; ?></b></li>
									<li>► Varış Zamanı <b>at <?php echo $jadwal['jam_tiba_jadwal']; ?> </b></li>
									<li>► Koltuk Seçiniz</li>
								...
								<table class="">
									...
									<tr>
										...
										<tr>
											...
											<div class="col-lg-4">
												...
												<div class="card mb-5">
													...
													<div class="alert alert-success" role="alert">
														<p>Koltuk seçimi yaptınız. Devam etmek için lütfen <i><b>ileri</b></i> düğmesine tıklayınız.</p>
														<div class='btn-group'>
															<a href="<?php echo base_url('tiket/cekjadwal/'.$tanggal.'/'.$asal['kd_tujuan'].'/'.$jadwal['kota_tujuan']) ?>" class='btn btn-default'>Geri Git</a>
											...
											if (count>4) {
											count = 4;
											swal("Hata", "En fazla 4 koltuk seçebilirsiniz!", "error");
											elem.checked = false;
											}
											}else{
											count = count-1;
