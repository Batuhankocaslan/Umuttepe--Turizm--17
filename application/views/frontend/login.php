						...
						<div class="card card-login mx-auto mt-10">
							...
							<div class="card-body" align="left">
								...
								<form action="<?php echo base_url() ?>login/cekuser" method="post">
									<div class="form-group">
										<div class="form-label-group">
											<input type="text" id="username" name="username" class="form-control" placeholder="Kullanıcı Adı/E-mail" required="required">
										</div>
									</div>
									<div class="form-group">
										<div class="form-label-group">
								...
								<div class="text-center">
									<p><a class="d-block mt-3" href="<?php echo base_url() ?>login/daftar">Şimdi Üye Ol</a>
									<hr>
									<b><a class="d-block mt-3" style="font-size:15px;" href="<?php echo base_url() ?>backend/login">Admin Olarak Giriş Yap</a></b>
