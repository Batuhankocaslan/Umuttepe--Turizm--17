							...
							<div class="card-body">
								<form action="<?php echo base_url() ?>login/daftar" method="post">
									<div class="form-group">
										<div class="form-group">
											<div class="form-label-group">
												<input type="text" name="name" class="form-control" required="" placeholder="Tam Ad" value="<?php echo set_value('name') ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="password" class="form-control form-control-user" name="password2" placeholder="Şifreyi Yeniden Giriniz">
										</div>
									</div>
								...
								<div class="text-center">
									<p>Zaten Üye Misiniz? <a class="" href="<?php echo base_url() ?>login">Şimdi Giriş Yap</a></p>
								</div>
							</div>
						</div>
					</div>
