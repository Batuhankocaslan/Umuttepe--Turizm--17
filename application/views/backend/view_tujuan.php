    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Varış Noktası Kodu [<?= $rute['kd_tujuan']; ?>]  </h6>
        </div>
        <div class="card-body">             
            <div class="card-body">+
              <div class="row">
                <div class="col-sm-6">
                  <p>Varış Şehri     : <b> <?= strtoupper($rute['kota_tujuan']) ?></b></p>
                  <p>Varış  : <b><?= $rute['terminal_tujuan']; ?></b></p>
                </div>
                <div class="col-sm-6">
                </div>
            </div>
