    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary"> Otobüs Kodu [<?= $bus['kd_bus']; ?>]  </h6>
        </div>
        <div class="card-body">             
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <p>Otobüs Adı : <b> <?= $bus['nama_bus']?>]</b></p>
                  <p>Otobüs Plakası: <b><?= strtoupper($bus['plat_bus']) ?></b></p>
                  <p>Yolcu Kapasitesi : <b><?= $bus['kapasitas_bus']; ?> Seat</b></p>
                  <p>Durum    : <b><?= $bus['status_bus'] ?></td>
                  <?php if ($bus['status_bus'] == '1') { ?>
                    <td class="btn-success"> Aktif</td> 
                    <?php } else { ?>
                    <td class="btn-danger">Aktif Değil</td>
                  <?php } ?></b></p>
                  <p>Bilgi : <b><?= $bus['desc_bus'] ?></b></p>
                </div>
                <div class="col-sm-6">
                </div>
            </div>
