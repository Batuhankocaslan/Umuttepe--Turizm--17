...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div class="container-fluid">
      <h1 class="h5 text-gray-800">Varış Noktası/Terminal</h1>
      <!-- DataTales Example -->
      ...
      <form action="<?= base_url() ?>backend/rute/tambahtujuan" method="post" >
        <div class="form-group">
          <div class="form-label-group">
            <input type="text" id="tujuan" name="tujuan" class="form-control" placeholder="Varış Noktası" required="required" autofocus="autofocus">
          </div>
        </div>
        <div class="form-group">
          <div class="form-label-group">
