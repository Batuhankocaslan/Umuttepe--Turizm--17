...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Rezervasyon Kodu [<?= $tiket[0]['kd_order']; ?>]  </h6>
        </div>
        <div class="card-body">
          <form action="<?= base_url().'backend/order/inserttiket' ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <label >Bilet Kodu <b><?= $row['kd_tiket'] ?></b></label>
                  <p>Müşteri Adı <b><?= $row['nama_order']; ?></b></p>
                  <hr>
                  <div class="row form-group">
                    <label for="nama" class="col-sm-4 control-label">Program Kodu</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="kd_jadwal" value="<?= $row['kd_jadwal'] ?>" readonly>
                    </div>
                  </div>
                  <div class="row form-group">
                    <label for="nama" class="col-sm-4 control-label">Yolcu Adı</label>
                    <div class="col-sm-8">
                  ...
                  <div class="row form-group">
                    <label for="" class="col-sm-4 control-label">Ödeme Limiti</label>
                    <div class="col-sm-8">
    ...
    <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                     ...
                     <p>Burada müşterilerin ödeme onayını kontrol edebilirsiniz. Müşterinin ödeme kanıtını görmek için görüntüle düğmesini tıklamanız yeterlidir.</p>
                    <hr>
                    <p class="mb-0"> <a href="<?= base_url('backend/konfirmasi/viewkonfirmasi/'.$tiket[0]['kd_order']) ?>" class="btn btn-success">Görüntüle</a></p>
                  </div>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      ...
                      <select class="form-control" name="status" required>
                          ...
                          <option value='3'>Seçimi Sil</option>
                           </select>
              ...
              <?php if ($tiket[0]['status_order'] == '1') { ?>
                ...
                <p><b>İptal Edilen Bilet</b></p>
            <?php }else{ ?>
              <a class="btn btn-primary float-right" href="<?= base_url('assets/backend/upload/etiket/'.$row['kd_order'].'.pdf') ?>" target="_blank"> E-Bileti yazdır</a> 
