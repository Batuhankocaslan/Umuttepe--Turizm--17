...
<html lang="en">
        ...
        <div class="container-fluid">
            ...
            <thead class="thead-dark">
                    <tr>
                        ...
                        <th>Rapor</th>
                        <th style="width:100px;text-align:center;">Hareket</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td style="text-align:center;vertical-align:middle">1</td>
                        <td style="vertical-align:middle;">Bilet Satış Rekoru</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel">Tarih Seöimi</h3>
                </div>
                <form class="form-horizontal" method="post" action="<?= base_url('backend/laporan/laportanggal') ?>" target="_blank">
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="control-label col-xs-3" > Şu tarihten: </label>
                            <div class="col-xs-9">
                                <div class='input-group date' id='datepicker' style="width:300px;">
                                    <input type='text' name="mulai" class="form-control datepicker" value="" placeholder="Şu tarihten..." required/>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" > Şu tarihe: </label>
                            <div class="col-xs-9">
                                <div class='input-group date' id='datepicker' style="width:300px;">
                                    <input type='text' name="sampai" class="form-control datepicker" value="" placeholder="Şu tarihe..." required/>
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
    ...
    <div class="modal fade" id="lap_jual_perbulan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel">Ay Seçiniz</h3>
                </div>
